import svgPaths from "./svg-ql5xedhkn3";

function CloseRound({ className }: { className?: string }) {
  return (
    <div className={className || "relative size-[24px]"} data-name="Close_round">
      <div className="absolute inset-1/4">
        <div className="absolute inset-[-8.33%]">
          <svg className="block size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
            <path d="M13 1L1 13" id="Vector 47" stroke="#33363F" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </svg>
        </div>
      </div>
      <div className="absolute flex inset-1/4 items-center justify-center" style={{ containerType: "size" }}>
        <div className="-scale-x-100 flex-none h-[100cqh] w-[100cqw]">
          <div className="relative size-full">
            <div className="absolute inset-[-8.33%]">
              <svg className="block size-full" fill="none" height="14" preserveAspectRatio="none" viewBox="0 0 14 14" width="14">
                <path d="M13 1L1 13" id="Vector 48" stroke="#33363F" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
              </svg>
            </div>
          </div>
        </div>
...
function Frame3() {
  return (
    <a className="content-stretch flex flex-col h-[40px] items-center justify-center relative shrink-0">
      <p className="[word-break:break-word] font-['Old_London:Regular',sans-serif] leading-[1.1] not-italic relative shrink-0 text-[20px] text-black text-left uppercase whitespace-nowrap">Rock food</p>
    </a>
  );
}
...
function Frame1() {
  return (
    <button className="content-stretch flex items-center justify-center relative shrink-0 size-[40px]">
      <CloseRound className="relative shrink-0 size-[24px]" />
    </button>
  );
}
...
function Header() {
  return (
    <div className="bg-[#f9f9f6] content-stretch cursor-pointer flex items-center justify-between overflow-clip px-[16px] py-[12px] relative shrink-0 w-[393px]" data-name="Header">
      <Frame3 />
      <Frame1 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="[word-break:break-word] content-stretch flex flex-col font-['Druk_Wide_Medium:Medium',sans-serif] gap-[24px] items-center justify-center not-italic p-[10px] relative size-full text-[20px] text-black text-center uppercase whitespace-nowrap">
      ...
      <a className="block cursor-pointer overflow-clip relative shrink-0 size-[40px]" href="https://www.instagram.com/rockfoodhossegor/?hl=fr" target="_blank" data-name="Social Icons">
        <div className="absolute inset-[0_0.06%_0.02%_0]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="39.9922" preserveAspectRatio="none" viewBox="0 0 39.9766 39.9922" width="39.9766">
            <path d={svgPaths.p2562b100} fill="#111111" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[24.32%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="20.5469" preserveAspectRatio="none" viewBox="0 0 20.5469 20.5469" width="20.5469">
            <path d={svgPaths.p2ba9da00} fill="#111111" id="Vector" />
          </svg>
        </div>
        <div className="absolute inset-[17.3%_17.3%_70.7%_70.7%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="4.79688" preserveAspectRatio="none" viewBox="0 0 4.79687 4.79688" width="4.79687">
            <path d={svgPaths.p2334f000} fill="#111111" id="Vector" />
          </svg>
        </div>
      </a>
      <div className="overflow-clip relative shrink-0 size-[40px]" data-name="Social Icons">
        <div className="absolute inset-[0_0_0.37%_0]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="39.8536" preserveAspectRatio="none" viewBox="0 0 40.0008 39.8536" width="40.0008">
            <path d={svgPaths.p2f1f8900} fill="#111111" id="Vector" />
          </svg>
        </div>
      </div>
      <div className="relative shrink-0 size-[40px]" data-name="Social Icons">
        <div className="absolute inset-[0_0.31%_0.31%_0]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" height="39.8769" preserveAspectRatio="none" viewBox="0 0 39.8779 39.8769" width="39.8779">
            <path d={svgPaths.p2647e2f0} fill="#111111" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
export default function OverlayMenuMobileDay() {
  return (
    <div className="bg-[#f9f9f6] content-stretch flex flex-col gap-[40px] items-center pb-[10px] pt-[50px] relative size-full" data-name="Overlay / Menu Mobile — Day">
      <Header />
      <Frame4 />
